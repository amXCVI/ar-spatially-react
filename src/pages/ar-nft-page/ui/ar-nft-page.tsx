            ...
            >
                <div className="col-span-12 bg-smoky-black-bg20 px-4 py-6 md:p-10">
                    <div className="flex flex-col lg:flex-row gap-10">
                        ...
                        <div className="flex flex-col lg:pt-12">
                            ...
                            <TextP className="text-spanish-gray mt-4 mb-10">
                            ...
                            <div className="flex gap-6 mt-auto justify-center md:justify-start flex-wrap">
                ...
                <div
                    className="col-span-12 xl:col-span-8 
                              bg-smoky-black-bg20 flex flex-col-reverse md:flex-row gap-6 px-4 py-6 md:p-10"
                >
