            ...
            >
                ...
                >
                    <div className="flex flex-col justify-between w-full h-full gap-10 lg:gap-20">
                        ...
                        >
                            <h1 className="bg-start-section-text-gradient bg-clip-text text-transparent lg:mr-auto">
                                OUR
                            </h1>
                ...
                <div className="container mx-auto hidden lg:flex flex-col items-center px-6 lg:-mt-6 xl:-mt-16">
                    ...
                    <Socials className="lg:mb-16 gap-8" itemClassName="fill-charleston-green" />
                </div>
            </section>
            {/* <OurVisionSection />
            <GetStartedSection />
